...
export async function POST(request: Request) {
  ...
  if (importType === "donation") {
    ...
    const paymentCandidates = buildPaymentCandidates(paymentActivities, households.results, openPledges.results, rememberedWithLegacyGifts, existingCompletedGifts.results);
