...
export async function GET(request: Request) {
  ...
  try {
    ...
    const [donors, gifts, givingActivities, interactions, recommendations, activityAudits, dataHealthRepairAudits, givingManagementAudits, dataImports, importChanges, householdChanges, paymentAssignments, paymentAssignmentAudits, refreshState, rollbackAudits, householdRollbackAudits] = await Promise.all([
