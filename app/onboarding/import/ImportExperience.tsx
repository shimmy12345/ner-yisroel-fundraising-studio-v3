...
export function ImportExperience() {
  ...
  async function showPreview() {
    ...
    try {
      ...
      const payload = await response.json() as { preview?: ImportPreview; jl?: JlPreview; error?: string };
      if (!response.ok || !payload.preview) throw new Error(payload.error ?? "The preview could not be prepared.");
      ...
      <div className="import-shell">
        ...
        {step === "preview" && preview && (
          <section className="import-card">
            ...
            {!jlDetected && <label className="update-existing-option">
        ...
        {step === "complete" && report && (
          <section className="import-card import-complete">
            ...
            <p className="import-lede">{report.imported.donors} donors, {report.imported.gifts} gifts, {report.imported.interactions} interactions, and {report.imported.reminders} reminders were processed.</p>
